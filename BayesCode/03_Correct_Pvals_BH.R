...
df <- read.csv("/Users/lfitzger/Test_BayesCode_desktop/Results_DiscreteTraits/model0.6_maps4states/All_genes_weighted_regression_results_slope50k_omega.tsv", header=T, sep="\t")
head(df)
...
write.csv(df_adj_gain, "/Users/lfitzger/Test_BayesCode_desktop/Results_DiscreteTraits/model0.6_maps4states/All_genes_adjusted_pvalues_gain.csv", row.names = FALSE)
write.csv(df_adj_loss, "/Users/lfitzger/Test_BayesCode_desktop/Results_DiscreteTraits/model0.6_maps4states/All_genes_adjusted_pvalues_loss.csv", row.names = FALSE)

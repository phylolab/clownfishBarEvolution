...
output_directory = '/Users/lfitzger/Test_BayesCode_desktop/Results_DiscreteTraits/model0.6_maps4states_root2/simapvsomega_colorgenes'

# Define the directory where your files are located
path_simap = '/Users/lfitzger/Test_BayesCode_desktop/Models/model0.6_clownfish4states_root2.map'

# Read gene names from the file
with open('/Users/lfitzger/Test_BayesCode_desktop/ColorGenes.txt', 'r') as f:
